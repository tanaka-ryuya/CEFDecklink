...
### Pipeline Simulator
*   **[Open Japanese Simulator (Run Directly in Browser)](https://htmlpreview.github.io/?https://github.com/tanaka-ryuya/CEFDecklink/blob/main/docs/pipeline_simulator.html)** ([Source File](docs/pipeline_simulator.html))
*   **[Open English Simulator (Run Directly in Browser)](https://htmlpreview.github.io/?https://github.com/tanaka-ryuya/CEFDecklink/blob/main/docs/pipeline_simulator_en.html)** ([Source File](docs/pipeline_simulator_en.html))
