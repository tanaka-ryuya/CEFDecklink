...
LoopThroughWithOpenGLCompositing::LoopThroughWithOpenGLCompositing() : QDialog(), pOpenGLComposite(NULL)
{
	ui = new Ui::LoopThroughWithOpenGLCompositingDialog();
	ui->setupUi(this);

	pOpenGLComposite = new OpenGLComposite(this);
