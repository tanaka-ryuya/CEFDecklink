...
vertex TextureMappingVertex vertexShader(unsigned int vertexID [[ vertex_id ]],
										 ...
										 constant Uniforms& uniforms [[buffer(VertexShaderInputIndexUniforms)]])
{
	...
	outVertex.renderedCoordinate = vector_float4(perspective.xyz, 1.0);
	outVertex.textureCoordinate = vertices[vertexID].textureCoordinate;
							  ...
							  texture2d<float, access::sample> texture [[ texture(0) ]])
{
	...
	return half4(texture.sample(textureSampler, mappingVertex.textureCoordinate));
};
