...
static const std::map<BMDDeckLinkStatusID, std::pair<GetStatusDataFunc, QString>> kStatusItems =
{
	...
	{ bmdDeckLinkStatusCurrentVideoOutputMode,				std::make_pair(std::bind(getStatusOutputDisplayMode, _1, bmdDeckLinkStatusCurrentVideoOutputMode),				"Video output display mode") },
	...
	{ bmdDeckLinkStatusReferenceSignalMode,					std::make_pair(std::bind(getStatusOutputDisplayMode, _1, bmdDeckLinkStatusReferenceSignalMode),					"Detected reference video mode") },
	...
	{ bmdDeckLinkStatusHDMIInputFRLRate,					std::make_pair(std::bind(getStatusInt, _1, bmdDeckLinkStatusHDMIInputFRLRate),								"HDMI input FRL rate") },
	{ bmdDeckLinkStatusHDMIOutputFRLRate,					std::make_pair(std::bind(getStatusInt, _1, bmdDeckLinkStatusHDMIOutputFRLRate),								"HDMI output FRL rate") },
	{ bmdDeckLinkStatusHDMIOutputTMDSLineRate,				std::make_pair(std::bind(getStatusFloat, _1, bmdDeckLinkStatusHDMIOutputTMDSLineRate),						"HDMI output TMDS line rate (MHz)") },
	{ bmdDeckLinkStatusHDMIOutputActualMode,				std::make_pair(std::bind(getStatusOutputDisplayMode, _1, bmdDeckLinkStatusHDMIOutputActualMode),			"HDMI output actual mode") },
	{ bmdDeckLinkStatusHDMIOutputActualFormatFlags,			std::make_pair(std::bind(getStatusFormatFlags, _1, bmdDeckLinkStatusHDMIOutputActualFormatFlags),			"HDMI output actual pixel format") },
};
...
QString getStatusOutputDisplayMode(com_ptr<IDeckLinkStatus>& deckLinkStatus, const BMDDeckLinkStatusID id)
{
	int64_t							statusInt;
