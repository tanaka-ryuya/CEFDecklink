...
void CFileCaptureDlg::StartCapture()
{
	...
	if (m_selectedDevice && 
		m_selectedDevice->StartCapture((BMDDisplayMode)m_modeListCombo.GetItemData(selectedVideoFormatIndex), kAudioSampleDepth, kAudioChannelCount, m_previewWindow, applyDetectedInputMode))
	{
...
BOOL	CFileCaptureDlg::OnInitDialog()
{
	...
	m_videoSampleQueue.Attach(new VideoSampleQueue());
