...
{
public:
	VideoBufferAllocator(unsigned int bufferSize);
	virtual ~VideoBufferAllocator() = default;
	...
	HRESULT __stdcall AllocateVideoBuffer(IDeckLinkVideoBuffer **allocatedBuffer) override;
