...
void	CFilePlaybackDlg::EnableVideoOutput()
{
	...
	if (!m_selectedDevice->EnableOutput(LookupDisplayMode(), m_sourceReader->GetVideoPixelFormat(), m_sourceReader->GetMinimumStride(), m_sourceReader->GetVideoColorspace(),
